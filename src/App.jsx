  ...
  return (
    <div style={{ margin: 0, padding: 0 }}>
      ...
      <div className="container" style={{ margin: 0, padding: 0 }}>
        <Tittle subTittle="OUR SERVICES" title="What We Offer" />
        <Programs />
        <About />
        <Tittle subTittle="Gallery" title="Reliva Photos" />
        <Gallery />
        <Tittle subTittle="TESTIMONIALS" title="What Our Clients Got to Say" />
        <Testimonials />/
